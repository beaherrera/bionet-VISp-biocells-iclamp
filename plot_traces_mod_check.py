...
parser.add_argument(
    "--bmtk_json_path",
    # nargs=1,
    default="bionet-VISp-biocells-iclamp/config.simulation.aibs_axon_mechanism_check.iclamp.json",
)
parser.add_argument(
    "--canata_output_dir",
    # nargs=1,
    default="cantata-bionet-VISp-biocells-iclamp-mechanism_check-dL5/out",
)
parser.add_argument(
    "--node_types",
    default="bionet-VISp-biocells-iclamp/network_axon_mechanism_check/v1_node_types.csv",
    type=str,
)
parser.add_argument("--save-dir", default="figs", type=str)
parser.add_argument(
    "--save-as", default="bionet-VISp-biocells-iclamp-mechanism_check_dL5", type=str
)
